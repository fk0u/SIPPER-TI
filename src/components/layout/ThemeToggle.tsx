...
export const ThemeToggle: React.FC = () => {
  ...
  useEffect(() => {
    setMounted(true);
    // Sync html element class on mount
  ...
  return (
    <div className="relative inline-flex items-center justify-center">
      {/* SVG Filters for Hand-drawn / Sketchy Effect */}
      <svg
      ...
      {/* Theme Switch Label & Container from Uiverse.io by mamyapro123 */}
      <label className="theme-switch" title={`Beralih ke mode ${theme === 'dark' ? 'Terang (Light)' : 'Gelap (Dark)'}`}>
        <input
